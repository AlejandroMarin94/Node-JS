...
const movies = [
  {
    ...
    descripcion: "Un narrador insomne conoce a un vendedor de jabón que cambiará su vida.",
    anio: 1999,
    valoracion: 8.8,
  ...
  },
  {
    id: 3,
    titulo: "Origen",
    descripcion: "Un ladrón que roba secretos del subconsciente recibe la misión inversa.",
    anio: 2010,
    valoracion: 8.8,
  ...
  },
  {
    id: 9,
    titulo: "Forrest Gump",
    descripcion: "La vida de un hombre sencillo en medio de grandes acontecimientos.",
    anio: 1994,
    valoracion: 8.8,
  ...
  },
  {
    id: 13,
    titulo: "Whiplash",
    descripcion: "Un joven baterista empujado al límite por su exigente profesor.",
    anio: 2014,
    valoracion: 8.5,
  ...
  },
  {
    id: 14,
    titulo: "La La Land",
    descripcion: "Un pianista de jazz y una actriz persiguen sus sueños en Los Ángeles.",
    anio: 2016,
    valoracion: 8.0,
